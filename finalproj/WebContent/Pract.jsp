...
<html><h1 align=center> VFORUM </h1>
<style>
html { height: 100% }
...
<form name="form" action="EmpLoginServlet" method="post" >
<div class="login">
    <input type="text" placeholder="empid" name="empid">  
  <input type="password" placeholder="password" name="password" >  
 
  <input type="submit" value="Sign In "onclick="return validate()"><br>
  
&emsp;&ensp; <a  href='Register.jsp'> New user..?</a href>
</div>
